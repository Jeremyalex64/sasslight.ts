/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 59525674830015b1d30a389ed205c9b4)
...
interface __BaseEnv_CloudflareEnv {
	...
	ADMIN_SECRET: string;
	WORKER_SELF_REFERENCE: Fetcher /* sasslight */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMIN_PASSWORD" | "ADMIN_SECRET">> {}
}
