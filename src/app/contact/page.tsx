		...
		<div>
			<section className="border-b border-zinc-800 bg-black px-4 py-12 sm:px-6 sm:py-16">
				<div className="mx-auto max-w-3xl text-center">
					<NavBrand size="lg" />
					<h1 className="mt-8 text-3xl font-bold text-white sm:text-4xl">Contact Us</h1>
					<p className="mx-auto mt-4 max-w-2xl text-lg text-zinc-400">
						Have a question, partnership inquiry, or product suggestion? We&apos;d love to hear from
						you.
					</p>
				</div>
			</section>
				...
				<div className="grid gap-8 lg:grid-cols-5">
					...
					<div className="space-y-6 lg:col-span-2">
						<div className="rounded-2xl border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-900">
							...
							<p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">support@sasslight.com</p>
						</div>
						...
						<div className="rounded-2xl border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-900">
							...
							<p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
								Interested in having your JVZoo product featured? Reach out with product details and
